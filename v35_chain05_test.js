...
const CHAIN = [
  { u: '我已经连续错十几次了。', keywords: ['連虧', '连亏', '本性', '正常', '懷疑', '怀疑', '怎麼辦', '怎么办'], forbid: [], engine: 'cognitive' },
  { u: '我就想把亏的拿回来。', keywords: ['拿回', '翻本', '較勁', '较劲', '倉位', '仓位', '放大'], forbid: ['連虧', '连亏'], engine: 'cognitive' },
  { u: '为什么越急越亏？', keywords: ['期望', '賭', '赌', '空間', '空间', '拿回'], forbid: ['倉位放大'], engine: 'cognitive' },
  { u: '怎么知道自己要失控了？', keywords: ['信號', '信号', '倉位', '仓位', '止損', '止损', '不敢', '臨界', '临界'], forbid: ['期望'], engine: 'cognitive' },
  { u: '我现在停是不是就彻底输了？', keywords: ['輸', '输', '認輸', '认输', '保護', '保护', '停'], forbid: ['信號', '信号'], engine: 'cognitive' },
  { u: '怎么让我停得住？', keywords: ['攻擊性', '收手', '規則', '规则', '降', '自動', '自动'], forbid: ['認輸', '认输'], engine: 'cognitive' },
  { u: '怎么证明？', keywords: ['連虧', '连亏', '收縮', '收缩', '虧損', '亏损', '停'], forbid: ['勝率', '胜率'], engine: 'cognitive' },
  { u: '我做不到，忍不住。', keywords: ['人性', '意志力', '規則', '规则', '正常', '不是你'], forbid: ['連虧', '连亏'], engine: 'cognitive' },
  { u: '它怎么执行？', keywords: ['不疲勞', '不疲劳', '規則', '规则', '執行', '执行', '翻本'], forbid: ['意志力'], engine: 'cognitive' },
...
(async () => {
  ...
  fs.writeFileSync(__dirname + '/v35_chain05_content.json', JSON.stringify(out, null, 1));
