...
const CHAIN = [
  { u: '震荡不是很好做吗？', keywords: ['掃', '扫', '挨打', '失血', '機會', '机会', '波動'], forbid: [], engine: 'cognitive' },
  { u: '多做不是多赚吗？', keywords: ['成本', '手續費', '手续费', '滑點', '滑点', '學費', '学费', '情緒'], forbid: ['掃', '扫'], engine: 'cognitive' },
  { u: '我就是来回被扫。', keywords: ['磨損', '磨损', '方向', '硬做', '本金', '止損', '止损'], forbid: ['手續費', '手续费'], engine: 'cognitive' },
  { u: '那震荡里就该不做吗？', keywords: ['保護', '保护', '躲開', '躲开', '不虧', '不亏', '收益'], forbid: ['磨損', '磨损'], engine: 'cognitive' },
  { u: '什么时候才该做？', keywords: ['機會', '机会', '噪音', '風險收益比', '风险收益比', '出手'], forbid: ['保護', '保护'], engine: 'cognitive' },
  { u: '系统怎么判断？', keywords: ['規則', '规则', '風險收益比', '风险收益比', '休眠', '不值得', '判斷'], forbid: ['噪音'], engine: 'cognitive' },
  { u: '怎么证明它震荡不动？', keywords: ['運行記錄', '运行记录', '頻繁開倉', '频繁开仓', '安靜', '安静', '擇時', '择时'], forbid: ['勝率', '胜率'], engine: 'cognitive' },
  { u: '不动手心里痒。', keywords: ['人性', '錯覺', '错觉', '手癢', '手痒', '怕錯過', '怕错过', '規則'], forbid: ['運行記錄', '运行记录'], engine: 'cognitive' },
  { u: '它怎么执行？', keywords: ['規則', '规则', '手癢', '手痒', '不怕錯過', '不怕错过', '執行'], forbid: ['人性'], engine: 'cognitive' },
...
(async () => {
  ...
  fs.writeFileSync(__dirname + '/v35_chain07_content.json', JSON.stringify(out, null, 1));
