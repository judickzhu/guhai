...
const CHAIN = [
  { u: '你们一个月能赚多少？', keywords: ['賺', '赚', '活', '別急', '别急'], forbid: [], engine: 'cognitive' },
  { u: '那你们靠什么让我不亏？', keywords: ['管不住', '做不到', '手', '紀律', '纪律'], forbid: ['一個月', '月'], engine: 'cognitive' },
  { u: '少亏怎么算赚？', keywords: ['50', '回本', '數學', '数学', '一半'], forbid: ['管不住'], engine: 'cognitive' },
  { u: '活下来怎么比赚钱重要？', keywords: ['在場', '在场', '活', '機會', '机会', '資格', '资格'], forbid: ['50%', '一半'], engine: 'cognitive' },
  { u: '那怎么防亏？', keywords: ['做死', '退', '停', '認錯', '认错', '先別', '先别'], forbid: ['機會', '机会'], engine: 'cognitive' },
  { u: '你们怎么防亏？', keywords: ['規則', '规则', '砍', '風控', '风控', '執行', '执行'], forbid: ['先別', '先别'], engine: 'cognitive' },
  { u: '怎么证明有用？', keywords: ['虧損', '亏损', '連虧', '连亏', '處理', '处理', '活'], forbid: ['勝率', '胜率'], engine: 'cognitive' },
  { u: '太慢了，什么时候能回本？', keywords: ['快', '慢', '暴富', '紀律', '纪律', '急'], forbid: ['連虧', '连亏'], engine: 'cognitive' },
  { u: '它怎么执行？', keywords: ['不疲勞', '不疲劳', '規則', '规则', '執行', '执行', '情緒', '情绪'], forbid: ['慢'], engine: 'cognitive' },
...
(async () => {
  ...
  fs.writeFileSync(__dirname + '/v35_chain02_content.json', JSON.stringify(out, null, 1));
